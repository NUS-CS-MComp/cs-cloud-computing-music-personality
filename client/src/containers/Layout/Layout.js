...
const Layout = ({ children }) => {
    ...
    return (
        <div
            className={`theme-${currentTheme} duration-200 transition-color m-auto bg-background-secondary h-full text-center flex flex-col md:gap-0 md:grid md:grid-flow-row md:grid-cols-6 md:grid-rows-6 xl:grid-cols-8 fhd:grid-cols-12`}
        >
