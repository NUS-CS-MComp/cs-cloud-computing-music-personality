...
from resources.personality import Inference, PersonalityScore
...
from resources.user import UserAuthentication, UserLogout, UserRecord
...
Api(USER_BLUEPRINT).add_resource(Inference, "/infer")
