    ...
    <nav className='w-auto flex flex-row items-start justify-around md:h-full md:flex-col md:justify-around md:items-center lg:items-start'>
        <Link to='/'>
            <div className='md:flex md:items-end'>
                <Icon name='home' className='h-8 m-auto md:m-0 lg:mr-3' />
        ...
        <Link to='/not-found'>
            <div className='md:flex md:items-end'>
                <Icon name='music' className='h-8 m-auto md:m-0 lg:mr-3' />
                <span className='hidden text-lg font-bold lg:inline-block'>
                    Insights
                </span>
            </div>
        ...
        <Link to='/not-found'>
            <div className='md:flex md:items-end'>
                <Icon name='user' className='h-8 m-auto md:m-0 lg:mr-3' />
                <span className='hidden text-lg font-bold lg:inline-block'>
                    Me
                </span>
            </div>
